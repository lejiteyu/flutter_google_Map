...
class GADPage extends StatelessWidget{

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Google ADS Mob.'),
      ),
      body: GAD(),
    );
  }
...
class GAD extends StatefulWidget {
  const GAD({this.initOption, Key key}) : super(key: key);

  final int initOption;
  @override
  _GADState createState() => _GADState(initOption: initOption);
}

class _GADState extends State<GAD> {
  _GADState({this.initOption = 1});
